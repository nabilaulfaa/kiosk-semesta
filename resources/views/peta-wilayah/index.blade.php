...
{{-- ❌ Tombol REFRESH lama dihapus dari sini, sudah dipindah ke footer --}}

@endsection

{{-- ✅ Override footer nav: BERANDA + REFRESH sejajar --}}
...
{{-- ✅ FIX: Leaflet JS wajib di-load SEBELUM kiosk-semesta.js --}}
